...
<div class="nerv-flow">
  <div class="nerv-flow-node in">launchd 스케줄 트리거</div>
  <div class="nerv-flow-arr">↓</div>
  <div class="nerv-flow-split">
    <div class="nerv-flow-split-head">시각 슬롯</div>
    <div class="nerv-flow-split-paths">
      <div class="nerv-flow-path"><span class="nerv-flow-tag">12시·18시 정기</span><div class="nerv-flow-node">경량 루트 검사</div></div>
      <div class="nerv-flow-path"><span class="nerv-flow-tag">23시 일일 종합</span><div class="nerv-flow-node">Full Council 검사</div></div>
    </div>
  </div>
  <div class="nerv-flow-arr">↓<span>합류</span></div>
  <div class="nerv-flow-split">
    <div class="nerv-flow-split-head">이상 탐지</div>
    <div class="nerv-flow-split-paths">
      <div class="nerv-flow-path"><span class="nerv-flow-tag">WARN 있음</span><div class="nerv-flow-node">finding 파일 생성</div></div>
      <div class="nerv-flow-path"><span class="nerv-flow-tag">이상 없음</span><div class="nerv-flow-node out">무음 — ALL_CLEAR</div></div>
    </div>
  </div>
  <div class="nerv-flow-arr">↓<span>WARN 경로</span></div>
  <div class="nerv-flow-node out">Discord 알림 발송</div>
</div>
