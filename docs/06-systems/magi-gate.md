...
<div class="nerv-flow">
  ...
  <div class="nerv-flow-split">
    ...
    <div class="nerv-flow-split-paths">
      ...
      <div class="nerv-flow-path"><span class="nerv-flow-tag">아니오</span>
        <div class="nerv-flow-split">
  ...
  <div class="nerv-flow-arr">↓<span>L0 → 통과 직행 (검증 우회)</span></div>
  <div class="nerv-flow-node out">통과 후 다음 역할로 전달</div>
</div>
