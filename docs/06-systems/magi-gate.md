...
<div class="nerv-flow">
  <div class="nerv-flow-node in">핸드오프 발생</div>
  <div class="nerv-flow-arr">↓</div>
  <div class="nerv-flow-node">유형 · 소비자수 · 방향 판정</div>
  <div class="nerv-flow-arr">↓</div>
  <div class="nerv-flow-split">
    <div class="nerv-flow-split-head">역방향 · 출판 · 반복 반려인가</div>
    <div class="nerv-flow-split-paths">
      <div class="nerv-flow-path"><span class="nerv-flow-tag">예</span><div class="nerv-flow-node">L3 Full Council · 3 LLM과 Chairman</div></div>
      <div class="nerv-flow-path"><span class="nerv-flow-tag">아니오</span><div class="nerv-flow-node">다중 소비자 · 생산 단계인가</div></div>
    </div>
  </div>
  <div class="nerv-flow-arr">↓</div>
  <div class="nerv-flow-split">
    <div class="nerv-flow-split-head">다중 소비자 · 생산 단계인가</div>
    <div class="nerv-flow-split-paths">
      <div class="nerv-flow-path"><span class="nerv-flow-tag">예</span><div class="nerv-flow-node">L2 Dual Review · 2 LLM과 Chairman</div></div>
      <div class="nerv-flow-path"><span class="nerv-flow-tag">아니오</span><div class="nerv-flow-node">역할 내부 파이프라인인가</div></div>
    </div>
  </div>
  <div class="nerv-flow-arr">↓</div>
  <div class="nerv-flow-split">
    <div class="nerv-flow-split-head">역할 내부 파이프라인인가</div>
    <div class="nerv-flow-split-paths">
      <div class="nerv-flow-path"><span class="nerv-flow-tag">예</span><div class="nerv-flow-node">L0 Audit Only · 로그만 기록</div></div>
      <div class="nerv-flow-path"><span class="nerv-flow-tag">아니오</span><div class="nerv-flow-node">L1 Quick Check · Chairman만</div></div>
    </div>
  </div>
  <div class="nerv-flow-arr">↓<span>L3 · L2 · L1 합류</span></div>
  <div class="nerv-flow-split">
    <div class="nerv-flow-split-head">교차 검증 결과</div>
    <div class="nerv-flow-split-paths">
      <div class="nerv-flow-path"><span class="nerv-flow-tag">PASS</span><div class="nerv-flow-node out">통과 후 다음 역할로 전달</div></div>
      <div class="nerv-flow-path"><span class="nerv-flow-tag">FAIL</span><div class="nerv-flow-node">반려 후 재작업 요청</div></div>
    </div>
  </div>
</div>
