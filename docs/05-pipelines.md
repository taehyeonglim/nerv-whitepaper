...
<div class="nerv-flow">
  <div class="nerv-flow-node in">PDF 입력</div>
  <div class="nerv-flow-arr">↓</div>
  <div class="nerv-flow-node">pdf-to-markdown</div>
  <div class="nerv-flow-arr">↓</div>
  <div class="nerv-flow-node">conversion-quality-checker</div>
  <div class="nerv-flow-arr">↓</div>
  <div class="nerv-flow-node">doi-resolver</div>
  <div class="nerv-flow-arr">↓</div>
  <div class="nerv-flow-node">citation-extractor</div>
  <div class="nerv-flow-arr">↓</div>
  <div class="nerv-flow-node">figure-table-extractor</div>
  <div class="nerv-flow-arr">↓<span>핸드오프</span></div>
  <div class="nerv-flow-split">
    <div class="nerv-flow-split-head">핸드오프 분기</div>
    <div class="nerv-flow-split-paths">
      <div class="nerv-flow-path"><div class="nerv-flow-node out">레이 분석지식 핸드오프</div></div>
      <div class="nerv-flow-path"><div class="nerv-flow-node out">카오루 탐색 핸드오프</div></div>
    </div>
  </div>
</div>
