...
<div class="nerv-flow">
  ...
  <div class="nerv-flow-split">
    ...
    <div class="nerv-flow-split-paths">
      <div class="nerv-flow-path"><span class="nerv-flow-tag">예</span><div class="nerv-flow-node">자연어 답변 생성</div></div>
      <div class="nerv-flow-path"><span class="nerv-flow-tag">아니오</span><div class="nerv-flow-node">웹 검색으로 보충</div></div>
    </div>
  </div>
