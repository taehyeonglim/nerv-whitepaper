...
<div class="nerv-flow">
  ...
  <div class="nerv-flow-arr">↓<span>2갈래 fan-out</span></div>
  <div class="nerv-flow-row">
    <div class="nerv-flow-node sm">결정론적 매칭 정확 별칭 인용</div>
    <div class="nerv-flow-node sm">후보 메타데이터 추출</div>
  </div>
  <div class="nerv-flow-arr">↓<span>후보 메타데이터 → 분기</span></div>
  <div class="nerv-flow-split">
    <div class="nerv-flow-split-head">Codex 위임 분기</div>
    <div class="nerv-flow-split-paths">
      <div class="nerv-flow-path"><span class="nerv-flow-tag codex">Codex gpt-5.5</span><div class="nerv-flow-node codex">의미 유사도 평가와 후보 랭킹</div></div>
  ...
  <div class="nerv-flow-arr">↓<span>결정론적 매칭 + 랭킹 합류</span></div>
